...
app.get("/jokes", function(req, res){
	...
	jokes[jokeIndex].id = jokeIndex;
	res.json(jokes[jokeIndex]);
});

app.post("/upvote", function(req, res){
	console.log("Someone tried to upvote joke #" + req.body.id);
	jokes[req.body.id].score++;
	res.json({
		newScore: jokes[req.body.id].score
	})
});
